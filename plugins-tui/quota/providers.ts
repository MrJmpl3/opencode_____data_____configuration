...
const readBooleanField = (data: Record<string, unknown>, key: string): boolean | undefined => {
  const value = data[key];
  return typeof value === "boolean" ? value : undefined;
};

const readNumericField = (data: Record<string, unknown>, key: string): number | undefined => {
  const value = data[key];
