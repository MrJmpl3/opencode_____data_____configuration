...
- [Services](../mrjmpl3-laravel-services/SKILL.md) - Service layer with null drivers
...
See [Services](../mrjmpl3-laravel-services/SKILL.md) for complete implementation examples.
...
See [DTOs](../mrjmpl3-laravel-dtos/SKILL.md) for test factory setup and implementation.
