...
privateChannel(Posts).on([PostCreated, PostUpdated, PostDeleted], refresh);
</script>
```
...
export default function useRemainingTaskCount() {
  ...
  const init = () => {
    ...
    // Real-time updates
    privateChannel(Tasks).on([TaskCreated, TaskCompleted], fetchTaskCount);
  };
...
- **[nuxt-config](../../4005-0103-nuxt-config/SKILL.md)** - Echo configuration
- **[nuxt-composables](../../4004-0102-nuxt-composables/SKILL.md)** - useRealtime
- **[nuxt-features](../../4008-0106-nuxt-features/SKILL.md)** - Real-time in queries
