...
**See [Actions](../../mrjmpl3-laravel-actions/SKILL.md) for complete implementation guide**
...
**See [DTOs](../../mrjmpl3-laravel-dtos/SKILL.md) for complete implementation guide**
...
**See [Models](../../mrjmpl3-laravel-models/SKILL.md) for custom builder implementation**
...
**See [Controllers](../../mrjmpl3-laravel-controllers/SKILL.md) for controller patterns**
...
**See [Actions](../../mrjmpl3-laravel-actions/SKILL.md) for action patterns**
