...
- [Models](../mrjmpl3-laravel-models/SKILL.md) - Model integration with custom builders
- [Controllers](../mrjmpl3-laravel-controllers/SKILL.md) - Using query objects in controllers
