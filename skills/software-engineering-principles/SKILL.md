...
- **Existing Guidelines:** - Follow existing guidelines in the project (e.g. AGENT.md, repository docs, etc.)
...
1.  **Simplification:** Simplify the code to make it cleaner and more maintainable.
2.  **Self-Code Review:**
    - Review the changes against the task requirements.
    - Ensure compliance with this `software-engineering-principles` skill (DRY, KISS, SOLID).
