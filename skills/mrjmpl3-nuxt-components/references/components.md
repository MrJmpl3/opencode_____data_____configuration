...
```vue
<template>
  <UButton v-if="can(CreatePost)" @click="openCreate"> Create Post </UButton>
</template>
```
...
- **[nuxt-forms](../../4009-mrjmpl3-nuxt-forms/SKILL.md)** - Form patterns
- **[nuxt-tables](../../4015-mrjmpl3-nuxt-tables/SKILL.md)** - Table patterns
- **[nuxt-pages](../../4012-mrjmpl3-nuxt-pages/SKILL.md)** - Page-level patterns
