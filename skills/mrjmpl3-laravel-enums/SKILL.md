...
- [State Machines](../mrjmpl3-laravel-state-machines/SKILL.md) - For complex state transitions
- [Models](../mrjmpl3-laravel-models/SKILL.md) - Model casts to enums
- [DTOs](../mrjmpl3-laravel-dtos/SKILL.md) - DTOs with enum properties
- [form-requests.md](../mrjmpl3-laravel-validation/references/form-requests.md) - Enum validation
...
See [State Machines](../mrjmpl3-laravel-state-machines/SKILL.md) for state machines.
