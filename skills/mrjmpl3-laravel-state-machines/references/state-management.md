...
- [Models](../../mrjmpl3-laravel-models/SKILL.md) - Model integration
- [Enums](../../mrjmpl3-laravel-enums/SKILL.md) - Simple state without transitions use enums
- [Packages](../../mrjmpl3-laravel-packages/SKILL.md) - Installing Spatie Model States
...
See [Enums](../../mrjmpl3-laravel-enums/SKILL.md) for simple state management.
...
**Use for complex states.** For simple statuses, use [Enums](../../mrjmpl3-laravel-enums/SKILL.md).
