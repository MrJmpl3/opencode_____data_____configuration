...
- [DTOs](../mrjmpl3-laravel-dtos/SKILL.md) - DTOs for passing data to actions
- [Controllers](../mrjmpl3-laravel-controllers/SKILL.md) - Controllers delegate to actions
- [Models](../mrjmpl3-laravel-models/SKILL.md) - Models accessed by actions
- [Testing](../mrjmpl3-laravel-testing/SKILL.md) - Testing with triple-A pattern
...
See [Multi-tenancy](../mrjmpl3-laravel-multi-tenancy/SKILL.md) for comprehensive patterns.
