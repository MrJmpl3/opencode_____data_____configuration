...
- [Query Builders](../mrjmpl3-laravel-query-builders/SKILL.md) - Custom query builders (not scopes)
- [Actions](../mrjmpl3-laravel-actions/SKILL.md) - Actions contain business logic
- [DTOs](../mrjmpl3-laravel-dtos/SKILL.md) - Casting model JSON columns to DTOs
