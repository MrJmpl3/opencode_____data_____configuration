...
export default function useTaskNotifications() {
  ...
  const init = () => {
    ...
    privateChannel(Tasks).on([TaskCreated, TaskCompleted], fetchCount);
  };
...
export default function useUserAndAuth() {
  /* mixed */
}
```
...
- **[nuxt-features](../../4008-0106-nuxt-features/SKILL.md)** - Queries/actions (prefer over data-fetching composables)
- **[nuxt-realtime](../../4013-0111-nuxt-realtime/SKILL.md)** - Real-time subscriptions
- **[nuxt-components](../../4003-0101-nuxt-components/SKILL.md)** - Using composables in components
