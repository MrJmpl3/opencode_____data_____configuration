...
- [Actions](../mrjmpl3-laravel-actions/SKILL.md) - Actions contain the domain logic
- [form-requests.md](../mrjmpl3-laravel-validation/references/form-requests.md) - Validation layer
- [DTOs](../mrjmpl3-laravel-dtos/SKILL.md) - DTOs for data transfer
- [structure.md](../mrjmpl3-laravel-architecture/references/structure.md) - Web vs API organization
