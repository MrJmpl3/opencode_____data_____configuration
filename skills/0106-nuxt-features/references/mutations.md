...
export default function createCommentForPostMutationFactory() {
  ...
  return async (postUlid: string, content: string): Promise<Comment> => {
    try {
      ...
      const { data: comment } = await commentApi.createForPost(postUlid, {
        content,
      });
      return comment;
    } finally {
...
- **[nuxt-features](../../4008-0106-nuxt-features/SKILL.md)** - Overview
- **[nuxt-repositories](../../4014-0112-nuxt-repositories/SKILL.md)** - Repository methods
- **[nuxt-composables](../../4004-0102-nuxt-composables/SKILL.md)** - useWait details
