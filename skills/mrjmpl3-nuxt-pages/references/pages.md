...
<template>
  <XCard title="Login">
    <form @submit.prevent="onSubmit">
      ...
      <UButton type="submit" class="w-full mt-4"> Login </UButton>
    </form>
  </XCard>
</template>
```
...
- **[nuxt-auth](../../4002-mrjmpl3-nuxt-auth/SKILL.md)** - Page authorization
- **[nuxt-components](../../4003-mrjmpl3-nuxt-components/SKILL.md)** - Component patterns
- **[nuxt-features](../../4008-mrjmpl3-nuxt-features/SKILL.md)** - Queries for pages
