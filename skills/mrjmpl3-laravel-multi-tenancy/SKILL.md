...
- [Actions](../mrjmpl3-laravel-actions/SKILL.md) - Central vs Tenanted action organization
- [Models](../mrjmpl3-laravel-models/SKILL.md) - Model organization
- [structure.md](../mrjmpl3-laravel-architecture/references/structure.md) - Directory organization
