...
<template>
  ...
  <UButton v-if="post.status.isEditable()" @click="publish"> Publish </UButton>
</template>
```
...
- **[nuxt-models](../../4011-0109-nuxt-models/SKILL.md)** - Using enums in models
- **[nuxt-components](../../4003-0101-nuxt-components/SKILL.md)** - Enum display patterns
