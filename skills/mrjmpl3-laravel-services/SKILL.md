...
- [Actions](../mrjmpl3-laravel-actions/SKILL.md) - Actions use services
- [Packages](../mrjmpl3-laravel-packages/SKILL.md) - Saloon for HTTP clients
- [Testing](../mrjmpl3-laravel-testing/SKILL.md) - Testing with null drivers
