...
export const formatAnchor = (lineNumber: number, content: string) => `${lineNumber}#${hashLine(lineNumber, content)}`

export const formatAnchoredLine = (lineNumber: number, content: string) => `${formatAnchor(lineNumber, content)}| ${content}`
