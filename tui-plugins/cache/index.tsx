...
import { detailLine, eventSessionId, formatCompactNumber, formatPercentRatio, slotSessionId } from './runtime/tui.ts';
import { summarizeCacheMessages } from './runtime/summary.ts';
